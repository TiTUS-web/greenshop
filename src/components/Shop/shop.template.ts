export function createShopTemplate {
    return `
    <section class="shop app__shop">
    <div class="container shop__container">
      <div class="sidenav shop__sidenav">
        <div class="container sidenav__container">
          <p class="title sidenav__title">Categories</p>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">House Plants</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Potter Plants</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Seeds</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Small Plants</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Big Plants</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Succulents</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Trerrariums</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Gardening</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle">Accessories</p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
        </div>

        <div class="container sidenav__container">
          <p class="title sidenav__title">Price Range</p>
          <div class="range shop__range">
            <input
              type="text"
              class="lever range__lever range_lever_left"
            />
            <input
              type="text"
              class="lever range__lever range_lever_right"
            />
            <div class="filler range__filler"></div>
          </div>
          <p class="subtitle sidenav__subtitle">
            Price:
            <b class="bold subtitle__bold">$39-$1230</b>
          </p>
          <button class="btn sidenav__btn" type="button">Filter</button>
        </div>

        <div class="container sidenav__container">
          <p class="title sidenav__title">Size</p>
          <button class="sidelink sidenav__sidelink">
            <p class="subtitle sidelink__subtitle sidelink_subtitle_active">
              Small
            </p>
            <p class="counter sidelink__counter">(33)</p>
          </button>
    ...
    <div class="container shop__container">
      <div class="navigation shop__navigation">
        <div class="container navigation__container">
          <button class="filterbtn navigation__filterbtn" type="button">
            All Plants
          </button>
          <button class="filterbtn navigation__filterbtn" type="button">
            New Arrivals
        ...
        <div class="container navigation__container">
          <label class="subtitle navigation__subtitle" for="dropdown"
            >Short by:</label
          >
          <select class="dropdown navigation__dropdown" id="dropdown">
            <option class="select dropdown__select" value="Default Sorting">
              Default Sorting
            </option>
            <option class="select dropdown__select" value="Default Sorting">
              Default Sorting
      ...
      <div class="products shop__products">
        <div class="card products__card">
          <div class="block card__block card_block_display">
            <img
              class="img card__img"
              src="src/images/card_1.png"
              alt="card"
            />
            <div class="display card__display">
              <button class="btn display__btn display_btn_basket">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 25 24"
              ...
              <button class="btn display__btn display_btn_favorites">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 18"
              ...
              <button class="btn display__btn display_btn_search">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
          ...
          <div class="block card__block">
            <p class="title card__title">Barberton Daisy</p>
            <p class="price card__price">$119.00</p>
          </div>
        </div>
        <div class="card products__card">
          <div class="block card__block card_block_display">
      ...
      <div class="pagination shop__pagination">
        ...
        <button class="btn pagination__btn pagination_btn_arrow">
          <img src="src/images/pagination__btn.svg" alt="arrow" />
        </button>
      </div>
    </div>
  </section>
